 // Generate floating particles
        ...
        document.querySelectorAll('.feature-card, .service-item, .benefit-item, .testimonial-card').forEach(el => {
            el.style.opacity = '0';
        ...
        document.querySelectorAll('button, .service-item, .feature-card').forEach(element => {
